...
export default function MensajesPage() {
  ...
  const abrirConfirmacion = (e: React.MouseEvent, convId: string) => {
    e.preventDefault();
    e.stopPropagation();
        ...
        >
          ...
          >
            ...
            <div className="flex gap-3">
              <button
                onClick={e => handleEliminarChat(confirmando, e)}
          ...
          {convs.map((conv) => {
            ...
            return (
              ...
              >
                ...
                {/* Botón eliminar */}
                <button
                  onClick={e => abrirConfirmacion(e, conv._id)}
                  className="flex-shrink-0 p-2 text-gray-300 hover:text-red-500 hover:bg-red-50 rounded-full transition-colors"
